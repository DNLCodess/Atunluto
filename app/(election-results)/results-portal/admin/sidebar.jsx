...
export default function Sidebar({ name }) {
  ...
  return (
    <aside
      ...
      aria-label="State Admin Navigation"
    >
      {/* Branding */}
        ...
        {NAV_ITEMS.map(({ href, label, icon, exact }) => {
          ...
          return (
            <Link
              ...
              className={`
                relative flex items-center gap-3 px-3 py-2.5 my-0.5 rounded-lg
                text-[13px] font-medium transition-all duration-150 no-underline group
                ${
                  isActive
