  ...
  return (
    <div className="min-h-screen flex font-[Poppins,sans-serif]">
      ...
      <div className="hidden lg:flex lg:w-[58%] xl:w-[60%] relative flex-col overflow-hidden">
        {/* Background image via Unsplash source */}
        <Image
        ...
        {/* Dark green gradient overlay — brand coloured, not generic black */}
      ...
      <div className="flex-1 flex flex-col bg-white min-h-screen">
        {/* Mobile logo bar — only visible below lg */}
                ...
                className={`w-full py-4 mt-2 rounded-xl text-[14px] font-bold text-white tracking-wide transition-all duration-200 border-none
                  ${
                    loading
                      ...
                      : "bg-[#1B5E20] cursor-pointer hover:bg-[#2E7D32] active:scale-[0.99] shadow-lg shadow-[#1B5E20]/25 hover:shadow-[#1B5E20]/35"
                  }`}
              >
                {loading ? (
